...
# starting_criteria = dict()
# input1 = input("Did you find the exact location of any more letters (green)?")
# input2 = input("Did you find out that any more letters are part of the word, but don't know their position yet (yellow)?")

# new_exact_letters = input1.split(" ")
# print(new_exact_letters)
# for new_letter in new_exact_letters:
#     starting_criteria[new_letter[0]] = new_letter[2]

# new_unspecified_letters = input2.split(" ")
# print(new_unspecified_letters)
# for new_letter in new_unspecified_letters:
#     starting_criteria[new_letter[0]] = 0

# print(starting_criteria)
...
# things to improve:
# sometimes repeated letters are necessary
# make sure we can get account for the possibility of exact letters being repeated
